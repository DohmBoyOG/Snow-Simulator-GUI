...
autofarms:CreateButton("Boss", function() 
    ...
    local yeti_teleport = yeti_options:CreateButton('Teleport', function()  gamePlayer.Character.HumanoidRootPart.CFrame =
                    CFrame.new(1612.04541, 357.895477, 98.2077637, 0.298467219, -0, -0.954419851, 0, 1, -0, 0.954419851, 0, 0.298467219)  end)
    ...
    local ginger_teleport = ginger_options:CreateButton('Teleport', function()  gamePlayer.Character.HumanoidRootPart.CFrame = CFrame.new(1746.72852, 770.231995, 144.258423, 0.854369879, 0, 0.519665301, 0, 1, 0, -0.519665301, 0, 0.854369879) end)
    ...
    local teddy_teleport = teddy_options:CreateButton('Teleport', function()  gamePlayer.Character.HumanoidRootPart.CFrame =
                    CFrame.new(1684.54663, 1302.91638, 159.315414, 0.996982157, -0, -0.0776311755, 0, 1, -0, 0.0776311755, 0, 0.996982157) end)
    ...
    local gumdrop_teleport = gumdrop_options:CreateButton('Teleport', function()  gamePlayer.Character.HumanoidRootPart.CFrame =
                    CFrame.new(1801.38916, 2031.46936, 111.645187, 0.462061107, 0, 0.886848092, 0, 1, 0, -0.886848092, 0, 0.462061107) end)
